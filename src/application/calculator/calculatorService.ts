      ...
      for (let i = 0; i < steps.length; i++) {
        ...
        switch (inputStep.type) {
          ...
          case 'exchange_rate':
            ...
            if (runningTotal === 0) {
              throw new Error("Exchange rate step requires a previous initial value step");
            }
          ...
          case 'percentage_reduction':
            ...
            if (runningTotal === 0) {
              throw new Error("Percentage reduction step requires a previous value step");
            }
          ...
          case 'fixed_reduction':
            ...
            if (runningTotal === 0) {
              throw new Error("Fixed reduction step requires a previous value step");
            }
            resultIntermediate = inputStep.value;
          ...
          default:
            throw new Error(`Unknown step type: ${inputStep.type}`);
        }
